    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">VIKKY Cafe'</a>
        </div>
...
<td>GH¢ <?php echo $values["food_price"]; ?></td>
<td>GH¢ <?php echo number_format($values["food_quantity"] * $values["food_price"], 2); ?></td>
...
<td align="right">GH¢ <?php echo number_format($total, 2); ?></td>
<td></td>
</tr>
</table>
<?php
